 ...
 * Implements inversion-of-control pattern for systematic testing and modular design.
 * 
 * Supported Commands:
...
typedef struct {
    ...
    nlink_config_result_t (*config_parser_func)(const char*, nlink_pkg_config_t*);
 ...
 */
typedef nlink_config_result_t (*nlink_config_parser_func_t)(const char*, nlink_pkg_config_t*);
 ...
 */
typedef int (*nlink_component_discovery_func_t)(const char*, nlink_pkg_config_t*);

/**
 * @brief Function typedef for validation dependency injection
 */
typedef nlink_config_result_t (*nlink_validation_func_t)(const nlink_pkg_config_t*);
