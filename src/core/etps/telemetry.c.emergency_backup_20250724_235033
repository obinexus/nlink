...
#include "semverx/core/types.h"  // for semverx_range_state_t, semverx_component_t etc.
#include "semverx/compatibility.h" // for compatibility_result_t and related enums
